...
class Cliente:
    ...
    def realizar_transacao(self, conta: "Conta", 
...
class ContaCorrente(Conta):
    def __init__(self, numero: int, cliente: Cliente, 
                 limite:float=500, limite_saques: int=3) -> None:
    ...
    def sacar(self, valor: float) -> bool:
        ...
        if excedeu_limite:
            ...
            print("\nOperação falhou! Núemro mpaximo de saques excedidos.")
        else:
...
def menu() -> None:
    ...
    mensagem_menu: str = "\n" + " Menu ".center(30, "#")
    with open("v3/opcoes_menu.txt", encoding="utf-8") as msg:
        mensagem_menu += "\n" + msg.read()
    mensagem_menu += "\n\n=> "
...
def criar_cliente(clientes: List[PessoaFisica]):
    ...
    print("\n Cliente cruado com sucesso!")


def criar_conta(numero_conta: int, clientes: PessoaFisica, 
                contas: List[Conta]):
    cpf: str = input("Informe o CPF do cliente: ")
    cliente: Cliente = filtrar_cliente(cpf, clientes)
